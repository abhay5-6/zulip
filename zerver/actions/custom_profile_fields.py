...
def custom_profile_field_to_dict(field: CustomProfileField) -> ProfileDataElementBase:
    field_dict = field.as_dict()
    field_dict["display_in_profile_summary"] = field.display_in_profile_summary
    field_dict["use_for_user_matching"] = field.use_for_user_matching
    return field_dict
    ...
    for field_value in values_to_delete:
        RealmAuditLog.objects.create(
            ...
            extra_data={
                ...
                "trigger": "dropdown_option_removed",
            },
        )
    ...
    *,
    ...
    if field.field_type in (
        ...
        if field_data is not None and field.field_type == CustomProfileField.DROPDOWN:
            remove_custom_profile_field_value_if_required(
                field, field_data, acting_user, event_time=now
            )
